...
interface DealsSummaryBannerProps {
  products: Product[];
  onSelectProduct: (product: Product) => void;
}

export const DealsSummaryBanner: React.FC<DealsSummaryBannerProps> = ({
  products,
  onSelectProduct,
}) => {
  const [activeTab, setActiveTab] = useState<'ofertas' | 'inflados'>('ofertas');
  ...
  return (
    <div className="bg-white dark:bg-stone-800 rounded-3xl border border-stone-200/80 dark:border-stone-700/80 p-5 shadow-sm space-y-4">
      ...
      {/* Tab Controls */}
      <div className="flex items-center justify-between flex-wrap gap-2 pb-2 border-b border-stone-100 dark:border-stone-700/60">
